            ...
            <section class="mb-32">
                ...
                <div class="flex justify-center">
                    <div class="text-center md:max-w-xl lg:max-w-3xl">
                        <h2 class="mb-12 px-6 text-4xl font-bold">
                            {t('contact.title')}
                        </h2>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                    ...
                    <form class="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                        ...
                        <div class="mb-3 w-full">
                            ...
                            <input type="text" class="px-2 py-2 border w-full outline-none rounded-md" id="exampleInput90" placeholder={t('contact.name_label')} />
                        </div>
                        ...
                        <button type="button"
                                class="mb-6 inline-block w-full rounded bg-black px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500">
                                 {t('contact.send')}
                        </button>
